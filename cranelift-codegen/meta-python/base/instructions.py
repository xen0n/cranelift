...
jump = Instruction(
        ...
        destination EBB.
        """,
        ins=(EBB, args), is_branch=True, is_terminator=True, has_delay_slot=True)
...
br_table = Instruction(
        ...
        ``call_indirect``.
        """,
        ins=(x, EBB, JT), is_branch=True, is_terminator=True, has_delay_slot=True)
...
indirect_jump_table_br = Instruction(
    ...
    """,
    ins=(addr, JT),
    is_branch=True, is_indirect_branch=True, is_terminator=True, has_delay_slot=True)
